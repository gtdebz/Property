...
<h2 class="text-center"><i class="fa fa-edit"></i> Edit Property Details Below</h2>
<hr class="alert-info" style="width:100%; color:#CCC">
			...
			if(isset($_POST['update'])){
			                     ...
			                     //   if(isset($image) && isset( $image_temp)){
									...
									//}
											...
											// }
												...
												$select_image = mysqli_query($db, $queryimg);
					...
					$editpropquery = mysqli_query($db, $queryupdate); 
				
				//product update validation
				if(!$editpropquery){echo "<h4 class='text-danger text-center'>Cannot update property details please try again</h4>";}else{	
				
				echo "<h4 class='text-success text-center'>Property details have been updated successfully !!</h4>";}
...
<label for="Property" class="col-lg-12 control-label">Name of Property</label>
...
<div class="form-group">
<label for="charge" class="col-lg-12 control-label">Monthly Charge</label>
<div class="col-lg-12">
...
<div class="form-group">
<label for="access" class="col-lg-12 mx-auto control-label">Access</label>
<div class="col-lg-12">
...
<div class="form-group">
<label for="floorspace" class="col-lg-12 control-label">Floor Space</label>
<div class="col-lg-12">
...
<div class="form-group">
<label for="rooms" class="col-lg-12 control-label">Rooms</label>
<div class="col-lg-12">
...
<div class="form-group">
<label for="utility" class="col-lg-12 control-label">Utility</label>
<div class="col-lg-12">
...
<div class="form-group">
<label for="images" class="col-lg-12 control-label">Featured Image</label>
<div class="col-lg-12">
        ...
        <div class="col-sm-12 col-md-4">
          <div class="widget-a">
            <div class="w-header-a">
              <h3 class="w-title-a text-brand">WeService</h3>
            </div>
            <div class="w-body-a">
              <p class="w-text-a color-text-a">
               Truly professional in property asset management.
              </p>
            </div>
